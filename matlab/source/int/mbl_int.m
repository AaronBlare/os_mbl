...
g                   = input_data(9);
seed                = input_data(10);
is_int              = input_data(11);
int_ist             = input_data(12);
int_isi             = input_data(13);
int_dt              = input_data(14);
int_db              = input_data(15);
int_de              = input_data(16);
int_dn              = input_data(17);
is_zev              = input_data(18);
is_zev_check        = input_data(19);
is_eg_stat          = input_data(20);
is_save_vec         = input_data(21);
is_save_mtx         = input_data(22);
fs_type             = input_data(23);
