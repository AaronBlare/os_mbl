...
code_base=$HOME/Work/os_mbl/matlab/plot/integration/rho_eval_diff
mkdir -p $scratch
mkdir -p $1
cd $scratch
cp $code_base/rho_eval_diff_pdf_dump.m .
cp $1/config.txt .
...
matlab -nodesktop -nosplash -r rho_eval_diff_pdf_dump
